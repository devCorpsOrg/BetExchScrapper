...
if __name__ == '__main__':
    ...
    time.sleep(5)
    driver.get('https://beetaexch.com/casino/dt202')
    while True:
        try:
    ...
    #     time.sleep(3)
    #     try:
    #         print(driver.find_element_by_id("playerDiv"))
    #         break
    #     except Exception as e:
    #         print(e)
    i = 0
    ...
    #     time.sleep(3)
    #     try:
    #         src = driver.find_element_by_id("h5live-playerDiv").get_attribute("src")
    #         bytes = get_file_content_chrome(driver, src)
    #         open("test.mp4", 'ab').write(bytes)
    #     except Exception as e:
    #         print(e)
